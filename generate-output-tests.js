...
const rules = {
  ...
  "ml-[JIT_VALUE]":
    '[dir="rtl"] .ml-\\[JIT_VALUE\\] { margin-left: JIT VALUE } [dir="ltr"] .ml-\\[JIT_VALUE\\] { margin-right: JIT VALUE }',
  "mr-[JIT_VALUE]":
    '[dir="rtl"] .mr-\\[JIT_VALUE\\] { margin-right: JIT VALUE } [dir="ltr"] .mr-\\[JIT_VALUE\\] { margin-left: JIT VALUE }',
  "px-[JIT_VALUE]":
    ".px-\\[JIT_VALUE\\] { padding-left: JIT VALUE; padding-right: JIT VALUE }",
  "pl-[JIT_VALUE]":
    '[dir="rtl"] .pl-\\[JIT_VALUE\\] { padding-left: JIT VALUE } [dir="ltr"] .pl-\\[JIT_VALUE\\] { padding-right: JIT VALUE }',
  "pr-[JIT_VALUE]":
    '[dir="rtl"] .pr-\\[JIT_VALUE\\] { padding-right: JIT VALUE } [dir="ltr"] .pr-\\[JIT_VALUE\\] { padding-left: JIT VALUE }',
  "inset-[JIT_VALUE]":
  ...
  "right-[JIT_VALUE]":
    '[dir="rtl"] .right-\\[JIT_VALUE\\] { right: JIT VALUE } [dir="ltr"] .right-\\[JIT_VALUE\\] { left: JIT VALUE }',
  "left-[JIT_VALUE]":
    '[dir="rtl"] .left-\\[JIT_VALUE\\] { left: JIT VALUE } [dir="ltr"] .left-\\[JIT_VALUE\\] { right: JIT VALUE }',
  "space-x-[JIT_VALUE]":
  ...
  "scroll-mr-[JIT_VALUE]":
    '[dir="rtl"] .scroll-mr-\\[JIT_VALUE\\] { scroll-margin-right: JIT VALUE } [dir="ltr"] .scroll-mr-\\[JIT_VALUE\\] { scroll-margin-left: JIT VALUE }',
  "scroll-ml-[JIT_VALUE]":
    '[dir="rtl"] .scroll-ml-\\[JIT_VALUE\\] { scroll-margin-left: JIT VALUE } [dir="ltr"] .scroll-ml-\\[JIT_VALUE\\] { scroll-margin-right: JIT VALUE }',
  "scroll-pr-[JIT_VALUE]":
    '[dir="rtl"] .scroll-pr-\\[JIT_VALUE\\] { scroll-padding-right: JIT VALUE } [dir="ltr"] .scroll-pr-\\[JIT_VALUE\\] { scroll-padding-left: JIT VALUE }',
  "scroll-pl-[JIT_VALUE]":
    '[dir="rtl"] .scroll-pl-\\[JIT_VALUE\\] { scroll-padding-left: JIT VALUE } [dir="ltr"] .scroll-pl-\\[JIT_VALUE\\] { scroll-padding-right: JIT VALUE }',
  "rounded-t-[JIT_VALUE]":
    ".rounded-t-\\[JIT_VALUE\\] { border-top-left-radius: JIT VALUE; border-top-right-radius: JIT VALUE }",
  "rounded-r-[JIT_VALUE]":
    '[dir="rtl"] .rounded-r-\\[JIT_VALUE\\] { border-top-right-radius: JIT VALUE; border-bottom-right-radius: JIT VALUE } [dir="ltr"] .rounded-r-\\[JIT_VALUE\\] { border-top-left-radius: JIT VALUE; border-bottom-left-radius: JIT VALUE }',
  "rounded-b-[JIT_VALUE]":
    ".rounded-b-\\[JIT_VALUE\\] { border-bottom-right-radius: JIT VALUE; border-bottom-left-radius: JIT VALUE }",
  "rounded-l-[JIT_VALUE]":
    '[dir="rtl"] .rounded-l-\\[JIT_VALUE\\] { border-top-left-radius: JIT VALUE; border-bottom-left-radius: JIT VALUE } [dir="ltr"] .rounded-l-\\[JIT_VALUE\\] { border-top-right-radius: JIT VALUE; border-bottom-right-radius: JIT VALUE }',
  "rounded-tl-[JIT_VALUE]":
    '[dir="rtl"] .rounded-tl-\\[JIT_VALUE\\] { border-top-left-radius: JIT VALUE } [dir="ltr"] .rounded-tl-\\[JIT_VALUE\\] { border-top-right-radius: JIT VALUE }',
  "rounded-tr-[JIT_VALUE]":
    '[dir="rtl"] .rounded-tr-\\[JIT_VALUE\\] { border-top-right-radius: JIT VALUE } [dir="ltr"] .rounded-tr-\\[JIT_VALUE\\] { border-top-left-radius: JIT VALUE }',
  "rounded-br-[JIT_VALUE]":
    '[dir="rtl"] .rounded-br-\\[JIT_VALUE\\] { border-bottom-right-radius: JIT VALUE } [dir="ltr"] .rounded-br-\\[JIT_VALUE\\] { border-bottom-left-radius: JIT VALUE }',
